...
var ru_default = {
  ...
  BASES_DESC: "\u041F\u0440\u0438\u043C\u0435\u043D\u044F\u0435\u0442\u0441\u044F \u043A \u043F\u0440\u0435\u0434\u0441\u0442\u0430\u0432\u043B\u0435\u043D\u0438\u044F\u043C \xAB\u0422\u0430\u0431\u043B\u0438\u0446\u0430\xBB \u0438 \xAB\u0421\u043F\u0438\u0441\u043E\u043A\xBB, \u043E\u043A\u0440\u0430\u0448\u0438\u0432\u0430\u0435\u0442\u0441\u044F \u0442\u043E\u043B\u044C\u043A\u043E \u0442\u0435\u043A\u0441\u0442",
...
var TagsColorFilesPlugin = class extends import_obsidian2.Plugin {
    ...
    this.observer = new MutationObserver((mutations) => {
      ...
      for (const m of mutations) {
        for (const node of Array.from(m.addedNodes)) {
          ...
          const el = node;
          if (el.classList.contains("nav-file") || el.querySelector(".nav-file-title") || // Bases virtualizes its rows: scrolling recycles a cell onto a
  ...
  removeBasesColors() {
    activeDocument.querySelectorAll(`.${BASES_COLORED_CLASS}`).forEach((el) => {
  ...
  getBasesNameLinks() {
    const links = [];
    activeDocument.querySelectorAll(".bases-view").forEach((view) => {
...
var TagsColorFilesSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  renderBody(root) {
    ...
    new import_obsidian2.Setting(root).setName(t("BASES_NAME")).setDesc(t("BASES_DESC")).addToggle((toggle) => {
